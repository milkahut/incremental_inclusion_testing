...
val attr_closure_inplace': paritygame -> strategy -> int -> Tcsset.IntSet.t -> bool -> int list array -> (int -> bool) -> bool -> int list
...
val attractor_closure_inplace_sol_strat: paritygame -> int list array -> (int -> bool) -> solution -> strategy -> Tcsset.IntSet.t -> Tcsset.IntSet.t -> (int list * int list)
...
val pg_set_closed: paritygame -> Tcsset.IntSet.t -> int -> bool

val pg_set_dominion: (paritygame -> solution * strategy) -> paritygame -> Tcsset.IntSet.t -> int -> strategy option
...
type dynamic_paritygame = (int * int * string option) Graph.DynamicGraph.dynamic_graph
