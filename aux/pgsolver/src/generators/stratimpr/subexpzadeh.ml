let show_help _ =
	print_string (Info.get_title  "Subexponential Strategy Iteration Zadeh Game");
	print_string ("Usage: subexpzadeh n\n\n" ^
...
Generators.register_generator generator_game_func "subexpzadeh" "Subexponential Strategy Iteration Zadeh Game";;